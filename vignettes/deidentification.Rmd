...
## Shifting modes
At the heart of *tangles* are the shifting modes that each on their own provides a mechanism for changing the original spatial coordinates. Used collectively they tangle up the original data so as to be completely unrecognizable. 
...
```{r t_plot, echo=T, eval= T, message=FALSE, warning= FALSE}
# Plotting
par(mfrow=c(1,2))
# original data
